...
const CHANNEL_CHAT_ID    = process.env.GEOPO_TELEGRAM_CHANNEL_CHAT_ID || '';
...
if (!CHAT_ID && !CHANNEL_CHAT_ID) {
  console.error('ERROR: at least one of GEOPO_TELEGRAM_CHAT_ID / GEOPO_TELEGRAM_CHANNEL_CHAT_ID is required');
  process.exit(1);
}
